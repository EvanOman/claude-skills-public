...
| Session History Search | `/evan-skills:session-history-search` | Search, list, and review past Claude Code sessions. Includes CLI tools (`cc-sessions`, `cc-search`, `cc-transcript`, `cc-index`) for keyword search, project filtering, tag-based discovery, and full transcript reading. |
